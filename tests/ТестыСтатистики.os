...
Процедура Тест_НечетныйРазмер() Экспорт
	...
	ТаблицаЗамеров = ТаблицаЗамеров("12, 15, 22, 25, 17, 28, 14", "100, 101, 102");
...
Процедура Тест_ЧетныйРазмер() Экспорт
	...
	ТаблицаЗамеров = ТаблицаЗамеров("12, 15, 22, 25, 17, 28, 20, 4", "100, 102");
...
Процедура Тест_ОдинаковыеЗначения() Экспорт
	...
	ТаблицаЗамеров = ТаблицаЗамеров("5, 5, 5, 5", "100, 100");
...
Процедура Тест_ОтрицательныеЗначения() Экспорт
	...
	ТаблицаЗамеров = ТаблицаЗамеров("-12, 15, -22, 25, 17, 28, 0, 4", "100, -100");
...
Процедура Тест_Разделить() Экспорт
	...
	ТаблицаЗамеров1 = ТаблицаЗамеров("32, 16, 64, 128", "100, 102");
	ТаблицаЗамеров2 = ТаблицаЗамеров("2, 8, 16, 4", "50, 51");

	Статистика1 = Новый СтатистикаБенчмарка(ТаблицаЗамеров1);
	Статистика2 = Новый СтатистикаБенчмарка(ТаблицаЗамеров2);
