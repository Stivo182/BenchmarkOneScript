...
Процедура ТестДолжен_ВозвращатьКопииЗамеров() Экспорт
	...
	ЗамерыВремениИзСтатистики = Статистика.ЗамерыВремени();
	ЗамерыПамятиИзСтатистики = Статистика.ЗамерыПамяти();

	// Проверка
	Ожидаем.Что(ЗамерыВремениИзСтатистики, "Замеры времени").ИмеетДлину(3);
	Ожидаем.Что(ЗамерыПамятиИзСтатистики, "Замеры памяти").ИмеетДлину(2);
