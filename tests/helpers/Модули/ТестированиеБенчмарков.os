...
Процедура ПодготовитьСреду(ИсполняющиеСреды) Экспорт

	ПроверитьУстановитьИсполняющиеСреды(ИсполняющиеСреды);

КонецПроцедуры

Процедура ПроверитьУстановитьИсполняющиеСреды(Версии)
