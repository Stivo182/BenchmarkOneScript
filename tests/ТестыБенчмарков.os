...
Процедура Тест_ЭкспортВMarkdown() Экспорт
	...
	ЧтениеТекста = Новый ЧтениеТекста(".\tests\fixtures\verified-report.md");
...
Процедура Тест_ЭкспортВJson() Экспорт
	...
	ЧтениеТекста = Новый ЧтениеТекста(".\tests\fixtures\verified-report.json");
	ТекстЭталон = ЧтениеТекста.Прочитать();
	ЧтениеТекста.Закрыть();
...
Процедура Тест_ЭкспортВXml() Экспорт
	...
	ЧтениеТекста = Новый ЧтениеТекста(".\tests\fixtures\verified-report.xml");
	ТекстЭталон = ЧтениеТекста.Прочитать();
	ЧтениеТекста.Закрыть();
...
Процедура Тест_ЭкспортВHtml() Экспорт
	...
	ЧтениеТекста = Новый ЧтениеТекста(".\tests\fixtures\verified-report.html");
	ТекстЭталон = ЧтениеТекста.Прочитать();
	ЧтениеТекста.Закрыть();
