...
&Тест
Процедура ТестДолжен_ВыброситьИсключениеПриПередачиОдиночногоПараметраКогдаМетодИмеетНесколькоПараметров() Экспорт
...
&Тест
Процедура ТестДолжен_ВыброситьИсключениеПриПараметраБенчмаркаОбщегоПоля() Экспорт
...
Процедура ТестДолжен_ВыброситьИсключениеНевозможностиОпределенияТипаКласса() Экспорт
	...
	Ожидаем
		.Что(Бенчмаркинг)
		.Метод("Запустить", ПараметрыМетода)
		.ВыбрасываетИсключение("Невозможно определить тип класса");
