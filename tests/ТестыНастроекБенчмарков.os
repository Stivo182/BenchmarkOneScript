...
Процедура Тест_БенчмаркСПараметрамиМетода() Экспорт
	...
	НаборыПараметров = Результат.Бенчмарки[0].НаборыПараметров();
...
Процедура Тест_ПараметрыМетодаДекларативно() Экспорт
	...
	Обертка = Новый ОберткаБенчмаркКласса(Тип("БенчмаркСПараметрамиМетода"));
	Обертка.Бенчмарки()[0]
		.ОчиститьПараметры()
...
Процедура Тест_БенчмаркСПараметрамиМетодаИПоля() Экспорт
	...
	Обертка = Новый ОберткаБенчмаркКласса(Тип("БенчмаркСПараметрамиМетодаИПоля"));
...
Процедура Тест_БенчмаркиСЭталоном() Экспорт
	...
	Обертка = Новый ОберткаБенчмаркКласса(Тип("БенчмаркиСЭталоном"));
	Конфигурация = Обертка.Конфигурация();
...
Процедура Тест_ЭталонДекларативно() Экспорт
	...
	Обертка = Новый ОберткаБенчмаркКласса(Тип("ПустойБенчмарк"));
	Конфигурация = Обертка.Конфигурация();
	Бенчмарки = Обертка.Бенчмарки();

	Бенчмарки[0].ИспользоватьКакЭталон();
...
Процедура Тест_БолееОдогоЭталона() Экспорт
	...
	Бенчмарки[0].ИспользоватьКакЭталон();
	Бенчмарки[1].ИспользоватьКакЭталон();
...
Процедура Тест_БенчмаркиПоКатегориям() Экспорт
	...
	Обертка = Новый ОберткаБенчмаркКласса(Тип("БенчмаркиПоКатегориям"));
	Конфигурация = Обертка.Конфигурация();
...
Процедура Тест_КатегорияДекларативно() Экспорт
	...
	Бенчмарки[0].УстановитьКатегорию("В");
...
Процедура Тест_БолееОдогоЭталонаПоКатегории() Экспорт
	...
	Бенчмарки[0].ИспользоватьКакЭталон(); // А1
	Бенчмарки[1].ИспользоватьКакЭталон(); // А2
...
Процедура Тест_СортировкаПоМетоду() Экспорт
	...
	Обертка = Новый ОберткаБенчмаркКласса(Тип("БенчмаркиССортировкой"));
	Конфигурация = Обертка.Конфигурация();
