...
Процедура Тест_УстановкаПараметровМетода() Экспорт
	...
	Результат = Бенчмаркинг.Запустить(Тип, ТестированиеБенчмарков.КонфигурацияПоУмолчанию(), ДескрипторыБенчмарков);
...
Процедура Тест_УстановкаКатегории() Экспорт
	...
	Результат = Бенчмаркинг.Запустить(Тип, Конфигурация, ДескрипторыБенчмарков);
