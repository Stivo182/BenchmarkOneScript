...
Процедура Тест_АннотацииКонфигурации() Экспорт
	...
	Ожидаем.Что(Конфигурация.ОбработчикСобытия("Инициализация")).Заполнено();
	Ожидаем.Что(Конфигурация.ОбработчикСобытия("Завершение")).Заполнено();
	Ожидаем.Что(Конфигурация.ОбработчикСобытия("ПередЗапуском")).Заполнено();
	Ожидаем.Что(Конфигурация.ОбработчикСобытия("ПослеЗапуска")).Заполнено();
...
Процедура Тест_ПроверкаОбработчикаСобытияБезПараметров() Экспорт
	...
	Ожидаем.Что(События).Не_().Содержит("ПередЗапуском");
...
Процедура Тест_ПроверкаУдаленияОбработчикаСобытия() Экспорт
	...
	Конфигурация = Обертка.Конфигурация();
	Конфигурация.УстановитьОбработчикПередЗапуском(Неопределено);
