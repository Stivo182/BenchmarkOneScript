...
Процедура Тест_АннотацииКонфигурации() Экспорт
	...
	Тип = Тип("БенчмаркСАннотацямиКонфигурации");
	Конфигурация = Новый КонфигурацияБенчмарков(Тип);

	ПроверитьКонфигурациюБенчмаркСАннотацямиКонфигурации(Конфигурация);
...
Процедура Тест_ДолженПроверитьСериализациюКонфигурацииJson() Экспорт
	...
	ПроверитьКонфигурациюБенчмаркСАннотацямиКонфигурации(КонфигурацияПрочитанная);

КонецПроцедуры

Процедура ПроверитьКонфигурациюБенчмаркСАннотацямиКонфигурации(Конфигурация)
