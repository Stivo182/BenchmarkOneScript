...
Процедура Тест_АннотацииКонфигурации() Экспорт
	...
	ПроцессорКоллекцииЭкспортеры = ПроцессорыКоллекций.ИзКоллекции(Экспортеры);
	...
	Ожидаем.Что(ПроцессорКоллекцииЭкспортеры.ЛюбойСоответствует(
		"Экспортер -> ТипЗнч(Экспортер) = Тип(""ЭкспортерРезультатовБенчмарковВMarkdown"")"
	)).ЭтоИстина();
	Ожидаем.Что(ПроцессорКоллекцииЭкспортеры.ЛюбойСоответствует(
		"Экспортер -> ТипЗнч(Экспортер) = Тип(""ЭкспортерРезультатовБенчмарковВJson"")"
	)).ЭтоИстина();
	Ожидаем.Что(ПроцессорКоллекцииЭкспортеры.ЛюбойСоответствует(
		"Экспортер -> ТипЗнч(Экспортер) = Тип(""ЭкспортерРезультатовБенчмарковВXml"")"
	)).ЭтоИстина();
	Ожидаем.Что(ПроцессорКоллекцииЭкспортеры.ЛюбойСоответствует(
		"Экспортер -> ТипЗнч(Экспортер) = Тип(""ЭкспортерРезультатовБенчмарковВHtml"")"
	)).ЭтоИстина();
...
Процедура Тест_ДобавлениеЭкспортера() Экспорт
	...
	Экспортер = Новый ЭкспортерРезультатовБенчмарковВMarkdown();
...
&Тест
Процедура Тест_ОчисткаЭкспортеров() Экспорт
	
	Экспортер = Новый ЭкспортерРезультатовБенчмарковВMarkdown();

	Конфигурация = Новый КонфигурацияБенчмарков();
	Конфигурация.ДобавитьЭкспортер(Экспортер);
	Конфигурация.ОчиститьЭкспортеры();
