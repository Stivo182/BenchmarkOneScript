...
Процедура Тест_ЭкспортВMarkdown() Экспорт
	...
	ОбработчикПослеКаждого = Новый ОбработчикСобытияБенчмарка("ОбработчикиСобытийБенчмарков.УстановкаВремени", СобытияБенчмарков.ПослеКаждого);
	ОбработчикПослеВсех = Новый ОбработчикСобытияБенчмарка("ОбработчикиСобытийБенчмарков.УстановкаМокСредыОкружения", СобытияБенчмарков.ПослеВсех);
	...
	Конфигурация
		.ДобавитьОбработчикСобытия(ОбработчикПослеКаждого)
		.ДобавитьОбработчикСобытия(ОбработчикПослеВсех)
