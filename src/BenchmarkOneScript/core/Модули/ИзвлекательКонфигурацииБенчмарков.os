...
Функция Извлечь(Объект) Экспорт
	...
	Если Не СвойстваКонструктора = Неопределено Тогда
		...
		ПрочитатьАннотациюКоличествоИтерацийПрогрева(СвойстваКонструктора, Конфигурация);
...
Процедура ПрочитатьАннотациюКоличествоИтерацийПрогрева(СвойстваКонструктора, Конфигурация)

	КоличествоИтерацийПрогрева = РаботаСАннотациямиБенчмарков.ЗначениеАннотацииКакЧисло(
		СвойстваКонструктора,
		"КоличествоИтерацийПрогрева"
	);

	Если Не КоличествоИтерацийПрогрева = Неопределено Тогда
		Конфигурация.УстановитьКоличествоИтерацийПрогрева(КоличествоИтерацийПрогрева);
	КонецЕсли;
