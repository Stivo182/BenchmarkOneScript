...
Функция Извлечь(Источник, Конфигурация = Неопределено) Экспорт
	...
	ПрочитатьОбработчикПередВсеми(РефлекторОбъекта, Объект, КонфигурацияБенчмарков);
	ПрочитатьОбработчикПослеВсех(РефлекторОбъекта, Объект, КонфигурацияБенчмарков);
	ПрочитатьОбработчикПередКаждым(РефлекторОбъекта, Объект, КонфигурацияБенчмарков);
	ПрочитатьОбработчикПослеКаждого(РефлекторОбъекта, Объект, КонфигурацияБенчмарков);
