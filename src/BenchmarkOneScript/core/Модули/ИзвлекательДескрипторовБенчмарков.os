...
//   НаборДескрипторов - НаборДескрипторовБенчмарков - Набор дескрипторов бенчмарков, в которую будут добавлены 
//                                                     извлеченные дескрипторы бенчмарков
//
// Возвращаемое значение:
//   НаборДескрипторовБенчмарков
Функция Извлечь(Источник, НаборДескрипторов = Неопределено) Экспорт
	...
	Если НаборДескрипторов = Неопределено Тогда
		Набор = Новый НаборДескрипторовБенчмарков();
	Иначе
