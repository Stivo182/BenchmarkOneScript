...
Функция ЗапускВозможен() Экспорт
	...
	ПроверитьЭталонныеИсполняющиеСреды();
	ПроверитьЭталонныеБенчмарки();
	ПроверитьПараметрыНаВозможностьСериализацииМеждуИсполняющимиСредами();
	ПроверитьОтсутствиеДелегатовПриНаличииДругихВерсийИсполняющейСреды();
...
Процедура ПроверитьЭталонныеИсполняющиеСреды()
...
Процедура ПроверитьПараметрыНаВозможностьСериализацииМеждуИсполняющимиСредами()
	...
	Для Каждого Параметр Из _Конфигурация.Параметры() Цикл
		ПроверитьПараметрНаВозможностьСериализацииМеждуИсполняющимиСредами(Параметр);
	КонецЦикла;
...
Процедура ПроверитьПараметрНаВозможностьСериализацииМеждуИсполняющимиСредами(Параметр)
...
Процедура ПроверитьОтсутствиеДелегатовПриНаличииДругихВерсийИсполняющейСреды()
