...
Функция ЗапуститьВсеБенчмарки(ДескрипторыБенчмарков)
	...
	ЗапуститьОбработчикИнициализации();
...
Функция ЗапуститьБенчмарк(ДескрипторБенчмарка, Параметры)
	...
	ЗапуститьОбработчикПередТестом(ДескрипторБенчмарка, ПараметрыМетода);
	...
	ЗапуститьОбработчикПослеЗапускаТеста(ДескрипторБенчмарка);
...
Процедура ЗапуститьОбработчикИнициализации()
...
Процедура ЗапуститьОбработчикЗавершения()
...
Процедура ЗапуститьОбработчикПередТестом(ДескрипторБенчмарка, ПараметрыБенчмарка)
...
Процедура ЗапуститьОбработчикПослеЗапускаТеста(ДескрипторБенчмарка)
...
Процедура ВывестиРезультатыБенчмарков(Результат)
	...
	ЦветнойВывод.ВывестиСтроку(Результат.Отчет.Легенда(), "ТемноСиний");
