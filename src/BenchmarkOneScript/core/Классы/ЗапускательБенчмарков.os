...
Перем _ОбъектБенчмарков; // Объект бенчмарков
Перем _Конфигурация; // КонфигурацияБенчмарков
Перем _ДескрипторыБенчмарков; // НаборДескрипторовБенчмарков
...
Процедура ПриСозданииОбъекта(Источник, Конфигурация = Неопределено, ДескрипторыБенчмарков = Неопределено)
	...
	Если Не ДескрипторыБенчмарков = Неопределено Тогда
		_ДескрипторыБенчмарков = ДескрипторыБенчмарков;
	Иначе
		_ДескрипторыБенчмарков = Новый НаборДескрипторовБенчмарков(_ОбъектБенчмарков);
	КонецЕсли;
...
//   Структура:
//     * ДескрипторыБенчмарков - НаборДескрипторовБенчмарков
...
Процедура ВывестиЗаголовокБенчмарка(ДескрипторБенчмарка, Параметры)
	...
	Текст = СтрШаблон(Символы.ПС + "// Benchmark: %1.%2", ДескрипторБенчмарка.ТипОбъекта(), ДескрипторБенчмарка.Метод());
