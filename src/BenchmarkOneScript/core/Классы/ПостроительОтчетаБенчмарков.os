...
Перем _РезультатыЗапусков; // см. ЗапускательБенчмарков.НоваяТаблицаРезультатов
...
//   РезультатыЗапусков - см. ЗапускательБенчмарков.НоваяТаблицаРезультатов
Процедура ПриСозданииОбъекта(Бенчмарки, Конфигурация, РезультатыЗапусков)
	
	_Бенчмарки = Бенчмарки;
...
Процедура ДобавитьКолонкиПараметров()
	...
	Для Каждого Бенчмарк Из _Бенчмарки Цикл
		Для Каждого Имя Из Бенчмарк.ИменаПараметров() Цикл
...
Процедура ДобавитьКолонкуКатегория()
	...
	Для Каждого Бенчмарк Из _Бенчмарки Цикл
		Если ЗначениеЗаполнено(Бенчмарк.Категория()) Тогда
