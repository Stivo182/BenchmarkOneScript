...
Процедура ДобавитьКолонки()
	...
	ДобавитьКолонкуРезультатаЗапускаКейса();
...
Процедура ДобавитьКолонкуРезультатаЗапускаКейса()
	_Отчет.Таблица.Колонки.Добавить(ИмяКолонкиРезультатаЗапускаКейса());
КонецПроцедуры
...
Процедура СкрытьКолонки()
	...
	СкрываемыеКолонки.Добавить(ИмяКолонкиРезультатаЗапускаКейса());
	СкрываемыеКолонки.Добавить(ИмяКолонкиГруппаЭталона());
...
Функция СкрыватьКолонку(Колонка)
	...
	Для Каждого СтрокаОтчета Из _Отчет.Таблица Цикл
		...
		Контекст.Вставить("Статистика", СтрокаОтчета[ИмяКолонкиРезультатаЗапускаКейса()].Статистика);
...
Процедура ЗаполнитьДанными()
	...
	Для Каждого РезультатЗапускаКейса Из _ЗапускиКейсов Цикл
		...
		СтрокаОтчета[ИмяКолонкиРезультатаЗапускаКейса()] = РезультатЗапускаКейса;
...
Функция ИмяКолонкиРезультатаЗапускаКейса()
