...
Процедура ПослеДесериализации(ПрочитанныеСвойства) Экспорт
	...
	ДессериализоватьОбработчики(ПрочитанныеСвойства);
	ДессериализоватьЭкспортеры(ПрочитанныеСвойства);
...
Процедура ДессериализоватьОбработчики(ПрочитанныеСвойства)
...
Процедура ДессериализоватьЭкспортеры(ПрочитанныеСвойства)
