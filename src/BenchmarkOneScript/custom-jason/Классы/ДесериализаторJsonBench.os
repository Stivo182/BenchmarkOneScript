...
// Соответствие - Прользовательские конвертеры для типа
//
Перем Конвертеры;
...
Функция ПреобразоватьОбъектДесериализации(ДесериализованныйОбъект, ТипОбъекта, ТипЭлементов = Неопределено, 
	ДесериализуемыеКлючи = Неопределено)

	Если Конвертеры[ТипОбъекта] <> Неопределено Тогда
		Возврат Конвертеры[ТипОбъекта].Десериализовать(ДесериализованныйОбъект, ЭтотОбъект);
