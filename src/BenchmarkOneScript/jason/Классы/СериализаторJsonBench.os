...
Функция ПреобразоватьТаблицуЗначений(ТаблицаЗначений, СериализуемыеКлючи) Экспорт
	...
	Результат = Новый Массив();
	СерриализоватьВсеКолонки = СериализуемыеКлючи.Количество() = 0;
	...
	Для Каждого СтрокаТаблицы Из ТаблицаЗначений Цикл
		...
		Для Каждого Колонка Из ТаблицаЗначений.Колонки Цикл
			...
			ИначеЕсли СерриализоватьВсеКолонки Тогда
				ИмяКлюча = Колонка.Имя;
			Иначе
				Продолжить;
			КонецЕсли;

			Если СерриализоватьВсеКолонки Или СериализуемыеКлючи.Свойство(Колонка.Имя) Тогда
