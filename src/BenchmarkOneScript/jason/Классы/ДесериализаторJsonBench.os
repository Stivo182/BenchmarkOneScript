...
Функция ПреобразоватьОбъектДесериализации(ДесериализованныйОбъект, ТипОбъекта, ТипЭлементов = Неопределено, ДесериализуемыеКлючи = Неопределено)
...
Функция ПреобразоватьПользовательскийТип(Объект, ТипОбъекта)
	...
	Для Каждого КлючИЗначение Из Объект Цикл
		...
		ЗначениеСвойства = ПреобразоватьОбъектДесериализации(ЗначениеСвойства, ТипСвойства, ТипЭлементов, ДесериализуемыеКлючи);
